...
(assert
  (and
    ...
    (not
      (and
        (<= (* (- 1) c_~a10~0) (- 3))
        (exists ((v_prenex_243 Int) (v_~a1~0_482 Int) (reminder_1 Int))
          (and
            (<= (* (- 1) v_~a1~0_482) (- 23))
            (<= (* (- 1) v_prenex_243) 0)
            (<= (+ (* (- 1) c_~a1~0) (* 1 reminder_1)) 300007)
            (<= (+ (* (- 1) v_prenex_243) (* 5 v_~a1~0_482)) (- 517989))
            (<= (+ (* (- 1) v_prenex_243) (* 299993 reminder_1)) 0)
            (<= (+ (* 1 v_prenex_243) (* (- 299993) reminder_1)) 299992)
          )
        )
        (or
          (and
