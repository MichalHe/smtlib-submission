...
(assert
  (and
    ...
    (exists ((main_#t~nondet0 Int) (main_#t~nondet1 Int) (main_#t~nondet2 Int) (reminder_2 Int))
      (and
        (= (* 1 reminder_2) 4)
        (<= (+ (* (- 4) c_main_~x~0) (* (- 2) c_main_~y~0) (* (- 1) c_main_~z~0) (* (- 8) main_#t~nondet0) (* (- 8) main_#t~nondet1) (* (- 8) main_#t~nondet2) (* 4294967296 reminder_2)) 0)
        (<= (+ (* 4 c_main_~x~0) (* 2 c_main_~y~0) (* 1 c_main_~z~0) (* 8 main_#t~nondet0) (* 8 main_#t~nondet1) (* 8 main_#t~nondet2) (* (- 4294967296) reminder_2)) 4294967295)
      )
    )
  )
)
