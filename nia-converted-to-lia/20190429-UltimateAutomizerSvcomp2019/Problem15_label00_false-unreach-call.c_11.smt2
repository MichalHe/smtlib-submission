...
(assert
  (and
    ...
    (not
      (exists ((v_prenex_81 Int) (quotient_30 Int) (reminder_31 Int))
        (and
          (<= (* (- 1) quotient_30) 0)
          (<= (* (- 1) v_prenex_81) 0)
          (<= (+ (* 1 c_~a29~0) (* (- 1) reminder_31)) 300021)
          (<= (+ (* (- 1) v_prenex_81) (* 5 quotient_30)) 0)
          (<= (+ (* 1 v_prenex_81) (* (- 5) quotient_30)) 4)
          (<= (+ (* (- 4) quotient_30) (* 299978 reminder_31)) 0)
          (<= (+ (* 4 quotient_30) (* (- 299978) reminder_31)) 299977)
        )
      )
    )
  )
