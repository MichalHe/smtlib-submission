  ...
  (exists ((reminder_2 Int) (reminder_0 Int))
    (and
      (and
        ...
        (or
          (not
            (exists ((v_prenex_2 Int) (v_subst_1 Int) (reminder_6 Int) (reminder_7 Int) (reminder_8 Int) (reminder_9 Int))
              (and
                (not
                  (or
                    ...
                    (<= (* (- 1) reminder_6) (- 58))
                    (<= (* 1 reminder_6) 47)
                    (<= (* (- 1) reminder_7) (- 2147483648))
                    (<= (* (- 1) reminder_9) (- 4294967296))
                    (<= (* 1 reminder_8) 47)
                  )
                )
                (<= (+ (* (- 1) v_prenex_2) (* 256 reminder_8)) 0)
                (<= (+ (* 1 v_prenex_2) (* (- 256) reminder_8)) 255)
                (<= (+ (* (- 10) reminder_7) (* (- 1) reminder_8) (* 4294967296 reminder_9)) 4294967248)
                (<= (+ (* 10 reminder_7) (* 1 reminder_8) (* (- 4294967296) reminder_9)) 47)
                (<= (+ (* (- 1) v_subst_1) (* 256 reminder_6)) 0)
                (<= (+ (* 1 v_subst_1) (* (- 256) reminder_6)) 255)
        ...
        (exists ((v_prenex_6 Int) (v_prenex_5 Int) (reminder_17 Int) (reminder_14 Int) (reminder_15 Int) (reminder_16 Int))
          (and
            (not
              (or
            ...
            (<= (+ (* (- 1) v_prenex_6) (* 256 reminder_16)) 0)
            (<= (+ (* 1 v_prenex_6) (* (- 256) reminder_16)) 255)
            (<= (+ (* (- 10) reminder_15) (* (- 1) reminder_16) (* 4294967296 reminder_17)) 4294967248)
            (<= (+ (* 10 reminder_15) (* 1 reminder_16) (* (- 4294967296) reminder_17)) 47)
            (<= (+ (* (- 1) v_prenex_5) (* 256 reminder_14)) 0)
            (<= (+ (* 1 v_prenex_5) (* (- 256) reminder_14)) 255)
